...
class SourceContractTests(unittest.TestCase):
    ...
    def test_root_makefile_checks_interpreters_before_pip_and_uses_safe_clean(self) -> None:
        ...
        self.assertIn("COCOTB_STABLE_CASES := generic xhci wifi sata gpu", source)
        self.assertNotIn("COCOTB_EXPERIMENTAL_CASES", source)
        self.assertNotIn("cocotb-test-experimental", source)
